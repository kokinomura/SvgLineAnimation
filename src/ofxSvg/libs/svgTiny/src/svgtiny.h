...
typedef enum {
    svgtiny_STROKE_LINECAP_BUTT,
    svgtiny_STROKE_LINECAP_ROUND,
    svgtiny_STROKE_LINECAP_SQUARE
} svgtiny_stroke_linecap;

typedef enum {
    svgtiny_STROKE_LINEJOIN_MITER,
    svgtiny_STROKE_LINEJOIN_BEVEL,
    svgtiny_STROKE_LINEJOIN_ROUND
} svgtiny_stroke_linejoin;
...
struct svgtiny_shape {
	...
	int stroke_width;
    svgtiny_stroke_linecap stroke_linecap;
    svgtiny_stroke_linejoin stroke_linejoin;
};
