...
//}
//
//vector<float> svgtiny_parse_viewBox(const string s, const struct svgtiny_parse_state *state)
//{
//    UNUSED(state);
//    vector<string> rect_str = split(s, ' ');
//    vector<float> rect;
//    for (int i=0; i<rect_str.size(); i++) {
//        // the second argument is not used.
//        rect.push_back(svgtiny_parse_length(rect_str[i].c_str(), 1.0, *state));
//    }
//    return rect;
//}
